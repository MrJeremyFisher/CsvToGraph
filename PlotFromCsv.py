...
column11 = [col5, col6]
column12 = [col7, col8]
df = pd.read_csv('C:\\Users\\jerem\\Documents\\input.csv', usecols=column9)
df2 = pd.read_csv('C:\\Users\\jerem\\Documents\\input.csv', usecols=column10)
df3 = pd.read_csv('C:\\Users\\jerem\\Documents\\input.csv', usecols=column11)
df4 = pd.read_csv('C:\\Users\\jerem\\Documents\\input.csv', usecols=column12)
...
plt.xlabel("Average In Academic Courses")
